...
const Contact = () => {
  ...
  <h2 className='text-center text-black text-5xl font-primary font-bold'>Contact Us!</h2>
      ...
      <div className="sm:col-span-2">
        ...
        <div className="relative mt-2.5">
          <div className="left-0 flex items-center">
            ...
            <select id="country" name="country" className="h-full rounded-md py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
              <option>US</option>
              <option>CA</option>
              <option>EU</option>
            </select>
